      ...
      <Card className="p-6 space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 px-4 py-2 bg-gray-900 rounded text-white">{showPassword ? pwd.password : '••••••••'}</code>
            <Button onClick={() => setShowPassword(!showPassword)} className="p-2 hover:bg-gray-700">
